    ...
    <Form className="space-y-8">
      ...
      {/* <div className="mb-10">
        ...
        <div className="grid grid-cols-1 gap-8">
          {otherPackages.map((pkg: PackageType) => {
            const isUpgrade =
              currentSubscription && pkg.price > currentSubscription.amount;
            const isDowngrade =
              currentSubscription && pkg.price < currentSubscription.amount;
            const isCurrent =
              currentSubscription && pkg.id === currentSubscription.package_id;
            ...
            return (
              <div
                ...
                className={`relative overflow-hidden rounded-xl transition-all duration-300 ${
                  isSelected
                    ? "ring-4 ring-blue-400 ring-opacity-50 transform scale-[1.01]"
                    : ""
                } ${
                  isCurrent
              ...
              >
                {isCurrent && (
                  <div className="absolute top-0 right-6 transform translate-y-[-50%] px-3 py-1 bg-blue-600 text-white text-xs font-medium rounded-full shadow-md">
                ...
                <div className="flex flex-col md:flex-row">
                  <div className="p-6 md:p-8 flex-1">
                    <div className="flex items-start mb-4">
                      ...
                      <div>
                        ...
                        <div className="mt-1 text-gray-600">{pkg.desc_en}</div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
                      {pkg.no_ideas !== 0 && (
                        <div className="flex items-start">
                          <FaCheckCircle className="h-5 w-5 text-green-500 mt-0.5 mx-3 flex-shrink-0" />
                          <span>
                            {pkg.no_ideas === -1 ? "Unlimited" : pkg.no_ideas}{" "}
                            {t('subscription.usage.ideas')}
                          </span>
                        </div>
                      )}
                      ...
                      {pkg.no_cvs !== 0 && (
                        <div className="flex items-start">
                          <FaCheckCircle className="h-5 w-5 text-green-500 mt-0.5 mx-3 flex-shrink-0" />
                          <span>
                            {pkg.no_cvs === -1 ? "Unlimited" : pkg.no_cvs}{" "}
                            {t('subscription.usage.cvs')}
                          </span>
                        </div>
                      )}
                      ...
                      {pkg.no_media !== 0 && (
                        <div className="flex items-start">
                          <FaCheckCircle className="h-5 w-5 text-green-500 mt-0.5 mx-3 flex-shrink-0" />
                          <span>
                            {pkg.no_media === -1 ? "Unlimited" : pkg.no_media}{" "}
                            {t('subscription.usage.media_uploads')}
                          </span>
                        </div>
                      )}
                      ...
                      {pkg.no_calls !== 0 && (
                        <div className="flex items-start">
                          <FaCheckCircle className="h-5 w-5 text-green-500 mt-0.5 mx-3 flex-shrink-0" />
                          <span>
                            {pkg.no_calls === -1 ? "Unlimited" : pkg.no_calls}{" "}
                            {t('subscription.usage.calls')}
                          </span>
                        </div>
                      )}
                      ...
                      {pkg.no_rfp !== 0 && (
                        <div className="flex items-start">
                          <FaCheckCircle className="h-5 w-5 text-green-500 mt-0.5 mx-3 flex-shrink-0" />
                          <span>
                            {pkg.no_rfp === -1 ? "Unlimited" : pkg.no_rfp}{" "}
                            {t('subscription.usage.rfps')}
                          </span>
                        </div>
                      )}
                  ...
                  <div className="p-6 md:p-8 bg-gray-50 md:border-l border-gray-200 md:w-64 flex flex-col justify-center">
                    <div className="text-center">
                      ...
                      {isUpgrade && (
                        <div className="text-xs text-green-600 font-medium flex items-center justify-center">
                          <FaInfoCircle className="h-3 w-3 mx-1" />
                          {t('subscription.unlock_features')}
                        </div>
                      )}
                      ...
                      {isDowngrade && (
                        <div className="text-xs text-amber-600 font-medium flex items-center justify-center">
                          <FaInfoCircle className="h-3 w-3 mx-1" />
                          {t('subscription.reduced_features')}
                        </div>
                      )}
                    </div>
                  </div>
