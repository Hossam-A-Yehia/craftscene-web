...
import SubscriptionForm from "@/components/organisms/CompleteProfileForm/SubscriptionForm/SubscriptionForm";
...
const SubscriptionTemplate: React.FC<SubscriptionTemplateProps> = () => {
