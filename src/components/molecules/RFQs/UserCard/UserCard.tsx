    ...
    >
      ...
      <div className="p-4">
        <div className="flex items-center mb-3">
          ...
          <div>
            <Text className=" mt-4 text-md font-semibold text-gray-900 text-center truncate">
              {name.length > 18 ? `${name.slice(0, 18)}...` : name}
            </Text>{" "}
            <div className="flex items-center mt-1">
              {country && (
                <Text className="text-xs text-gray-600 mr-1 whitespace-nowrap">
                  {country},
                </Text>
              )}
              <Text className="text-xs text-gray-600">{city}</Text>
            </div>
          </div>
        </div>
      </div>
