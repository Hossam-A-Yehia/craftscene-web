import { ValuesOptionType } from "./Ideas";
...
export interface CheckboxGroupValuesProps {
  title: string;
  options: ValuesOptionType[];
  selectedOptions: ValuesOptionType[];
  onChange: (selected: ValuesOptionType[]) => void;
}
